...
export default function Home() {
  ...
  return (
    <div className="w-full h-full">
      ...
      <h2 className="text-3xl md:text-4xl xl:text-5xl font-bold text-gray-800 text-center mb-8">
        About Me
      </h2>
      <div className="max-w-4xl mx-auto text-left"> {/* Add text-left to align text inside the paragraphs to the left */}
